export function Footer() {
  return (
    <footer className="bg-[#24ABE2] dark:bg-gray-900">
      <div className="mx-auto w-full mx-auto max-w-screen-xl">
        <div className="grid grid-cols-1 px-4 py-6 lg:py-8 md:grid-cols-3">
        ...
        <div className="px-4 py-6 bg-[#24ABE2] text-[#000] dark:bg-gray-700 md:flex md:items-center md:justify-center border-t border-gray-300">
          <span className="text-sm text-[#000] dark:text-gray-300 sm:text-center">
            © 2025{" "}
